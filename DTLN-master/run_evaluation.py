...
def process_audio_array(model, in_data):
    """
    Adapted from the original function process_file() -
    this function takes audio arrays as inputs and outputs the enhanced audio as arrays
    :return:
    """
    # get length of audio
