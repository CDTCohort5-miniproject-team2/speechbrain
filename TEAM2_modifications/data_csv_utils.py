...
def make_temporary_audio_files_csv(data_dirpath, write_csv_to=""):
    ...
    if write_csv_to == "":
        write_csv_to = f"{data_dirpath}/temporary_data_csv.csv"

    new_df.to_csv(write_csv_to)

def main():
    hpc_storage_dirpath = "/mnt/parscratch/users/acp23jlc/private/kroto_data"
    make_temporary_audio_files_csv(hpc_storage_dirpath,
                                   write_csv_to="temporary_data_csv.csv")
